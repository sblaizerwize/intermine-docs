...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.e55737e8fbb36201f4003d7d73a775fdd9a7b61019a1b6ad4d5a5dbbbb42242d.js',function(){input.required=false;search();});}
